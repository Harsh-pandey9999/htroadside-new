...
@section('meta')
    <meta name="description" content="{{ $category->description ?? 'Browse all articles in the ' . $category->name . ' category on HT Roadside Assistance blog.' }}">
    <meta name="keywords" content="{{ $category->name }}, roadside assistance, blog, articles">
@endsection
                    ...
                    @else
                        <div class="bg-gray-50 rounded-lg p-12 text-center mb-12" data-aos="fade-up">
                            ...
                            <p class="text-gray-600 mb-6">
                                There are no articles in this category yet. Please check back later or explore other categories.
                            </p>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 mb-8" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <ul class="space-y-2">
                            @foreach($categories as $cat)
                                <li class="flex items-center justify-between {{ $cat->id === $category->id ? 'text-primary-600 font-semibold' : 'text-gray-700' }}">
                                    <a href="{{ route('blog.category', $cat->slug) }}" class="{{ $cat->id === $category->id ? 'text-primary-600' : 'text-gray-700 hover:text-primary-600' }} transition-colors">
                                        {{ $cat->name }}
                                    </a>
