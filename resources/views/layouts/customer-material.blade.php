...
<head>
    ...
    <title>{{ config('app.name', 'HT Roadside Assistance') }} - Customer</title>
...
<body class="antialiased">
        ...
        <aside class="md-drawer md:translate-x-0" id="main-drawer">
            ...
            <div class="md-drawer-content overflow-y-auto h-[calc(100vh-4rem)]">
                <nav class="py-2">
                    ...
                    <a href="{{ route('customer.dashboard') }}" class="md-drawer-item {{ request()->routeIs('customer.dashboard') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">dashboard</span>
                        <span>Dashboard</span>
                    </a>
                    
                    <a href="{{ route('customer.requests.create') }}" class="md-drawer-item {{ request()->routeIs('customer.requests.create') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">add_circle</span>
                        <span>New Request</span>
                    </a>
                    
                    <a href="{{ route('customer.requests.index') }}" class="md-drawer-item {{ request()->routeIs('customer.requests.index') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">assignment</span>
                        <span>My Requests</span>
                    </a>
                    
                    <a href="{{ route('customer.subscriptions.index') }}" class="md-drawer-item {{ request()->routeIs('customer.subscriptions.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">card_membership</span>
                    ...
                    <a href="{{ route('customer.profile') }}" class="md-drawer-item {{ request()->routeIs('customer.profile') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">account_circle</span>
                        <span>Profile</span>
                    </a>
                    
                    <a href="{{ route('customer.vehicles.index') }}" class="md-drawer-item {{ request()->routeIs('customer.vehicles.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">directions_car</span>
                        <span>My Vehicles</span>
                    </a>
                    
                    <a href="{{ route('customer.contacts.index') }}" class="md-drawer-item {{ request()->routeIs('customer.contacts.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">contacts</span>
                        <span>Emergency Contacts</span>
                    </a>
                    
                    <a href="{{ route('customer.payments.index') }}" class="md-drawer-item {{ request()->routeIs('customer.payments.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">credit_card</span>
                        <span>Payment Methods</span>
                    </a>
                    
                    <a href="{{ route('customer.settings') }}" class="md-drawer-item {{ request()->routeIs('customer.settings') ? 'active' : '' }}">
        ...
        <div class="flex-1 flex flex-col md:ml-64">
            ...
            <header class="md-app-bar bg-primary-600 text-white">
                ...
                <div class="md-app-bar-actions">
                    <!-- Emergency Button -->
                    <a href="{{ route('customer.emergency') }}" class="hidden md:flex items-center mr-4 bg-error-600 hover:bg-error-700 text-white px-4 py-1.5 rounded-full transition-colors">
                        <span class="material-icons text-sm mr-1">emergency</span>
                        <span>Emergency</span>
                    </a>
                    ...
                    <div class="relative ml-2" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak class="absolute right-0 mt-2 w-48 bg-surface-1 rounded-md shadow-md z-50">
                            <div class="py-1">
                                <a href="{{ route('customer.profile') }}" class="block px-4 py-2 text-on-surface-high hover:bg-surface-3">
                                    <span class="material-icons-outlined text-sm mr-2">account_circle</span>
                                    Profile
                                </a>
                                <a href="{{ route('customer.settings') }}" class="block px-4 py-2 text-on-surface-high hover:bg-surface-3">
    ...
    <a href="{{ route('customer.emergency') }}" class="md:hidden fixed bottom-6 left-6 bg-error-600 hover:bg-error-700 text-white p-4 rounded-full shadow-lg transition-colors">
