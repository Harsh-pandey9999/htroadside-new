...
<head>
    ...
    <title>{{ config('app.name', 'HT Roadside Assistance') }} - Admin</title>
        ...
        <aside class="md-drawer md:translate-x-0" id="main-drawer">
            ...
            <div class="md-drawer-content overflow-y-auto h-[calc(100vh-4rem)]">
                <nav class="py-2">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="md-drawer-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">dashboard</span>
                        <span>Dashboard</span>
                    </a>
                    
                    <a href="{{ route('admin.users.index') }}" class="md-drawer-item {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">people</span>
                        <span>Users</span>
                    </a>
                    
                    <a href="{{ route('admin.providers.index') }}" class="md-drawer-item {{ request()->routeIs('admin.providers.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">handyman</span>
                        <span>Service Providers</span>
                    </a>
                    
                    <a href="{{ route('admin.services.index') }}" class="md-drawer-item {{ request()->routeIs('admin.services.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">build</span>
                        <span>Services</span>
                    </a>
                    
                    <a href="{{ route('admin.requests.index') }}" class="md-drawer-item {{ request()->routeIs('admin.requests.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.payments.index') }}" class="md-drawer-item {{ request()->routeIs('admin.payments.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">payments</span>
                        <span>Payments</span>
                    </a>
                    
                    <a href="{{ route('admin.subscriptions.index') }}" class="md-drawer-item {{ request()->routeIs('admin.subscriptions.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.applications.index') }}" class="md-drawer-item {{ request()->routeIs('admin.applications.*') ? 'active' : '' }}">
                        <span class="material-icons-outlined mr-3">work</span>
                        <span>Applications</span>
                    </a>
                    
                    <a href="{{ route('admin.settings.index') }}" class="md-drawer-item {{ request()->routeIs('admin.settings.*') ? 'active' : '' }}">
            ...
            <header class="md-app-bar bg-primary-600 text-white">
                ...
                <div class="md-app-bar-actions">
                    ...
                    <div class="relative hidden md:block mr-4">
                        <span class="material-icons absolute left-3 top-1/2 transform -translate-y-1/2 text-white text-opacity-70">search</span>
                        <input type="text" placeholder="Search..." class="bg-white bg-opacity-20 text-white placeholder-white placeholder-opacity-70 rounded-full py-2 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-40 w-64">
                    </div>
                    ...
                    <div class="relative ml-2" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-cloak class="absolute right-0 mt-2 w-48 bg-surface-1 rounded-md shadow-md z-50">
                            <div class="py-1">
                                <a href="{{ route('admin.profile') }}" class="block px-4 py-2 text-on-surface-high hover:bg-surface-3">
                                    <span class="material-icons-outlined text-sm mr-2">account_circle</span>
                                    Profile
                                </a>
                                <a href="{{ route('admin.settings.index') }}" class="block px-4 py-2 text-on-surface-high hover:bg-surface-3">
